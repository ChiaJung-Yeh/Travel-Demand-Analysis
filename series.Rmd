...
project_table=data.frame(Items=c("Paper", "Slides", rep("Code", 3)),
                     Download=c(rep("必填參數", 3), rep("選填參數", 2)))
